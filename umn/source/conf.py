...
otcdocs_repo_name = 'opentelekomcloud-docs/application-service-mesh'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/application-service-mesh/umn/'
...
html_title = "Application Service Mesh - User Guide"
