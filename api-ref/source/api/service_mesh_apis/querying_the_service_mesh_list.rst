...
.. table:: **Table 3** Parameters in the response body
   ...
   +------------+----------------------------------------------------------+---------------------------------------------------------------------+
   | items      | Array of :ref:`Table 4 <asm_api_0104___d1e3384>` objects | Service mesh list.                                                  |
   +------------+----------------------------------------------------------+---------------------------------------------------------------------+
...
.. table:: **Table 4** Mesh
   ...
   +-----------------------+-------------------------------------------------+------------------------------------------------------------------------------------------------+
   | metadata              | :ref:`Table 5 <asm_api_0104___d1e3461>` object  | Basic information about the service mesh. Metadata is a collection of attributes.              |
   +-----------------------+-------------------------------------------------+------------------------------------------------------------------------------------------------+
   | spec                  | :ref:`Table 6 <asm_api_0104___d1e3536>` object  | Detailed description of the service mesh. ASM creates or updates the service mesh by **spec**. |
   +-----------------------+-------------------------------------------------+------------------------------------------------------------------------------------------------+
   | status                | :ref:`Table 15 <asm_api_0104___d1e3837>` object | Service mesh status,                                                                           |
   |                       |                                                 |                                                                                                |
...
.. table:: **Table 6** MeshSpec
   ...
   +-----------------------+------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+
   | extendParams          | :ref:`Table 7 <asm_api_0104___d1e3599>` object | Extensions of the service mesh.                                                                                                     |
   +-----------------------+------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+
   | ipv6Enable            | Boolean                                        | Whether the service mesh supports IPv6.                                                                                             |
   +-----------------------+------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+
   | config                | :ref:`Table 9 <asm_api_0104___d0e5847>` object | Service mesh configuration.                                                                                                         |
   +-----------------------+------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+

.. _asm_api_0104___d1e3599:

.. table:: **Table 7** MeshExtendParams

   +-----------+----------------------------------------------------------+------------------------------------------+
   | Parameter | Type                                                     | Description                              |
   +===========+==========================================================+==========================================+
   | clusters  | Array of :ref:`Table 8 <asm_api_0104___d1e3631>` objects | Cluster information in the service mesh. |
   +-----------+----------------------------------------------------------+------------------------------------------+

.. _asm_api_0104___d1e3631:

.. table:: **Table 8** MeshCluster
...
.. _asm_api_0104___d0e5847:

.. table:: **Table 9** MeshConfig

   +-----------------+-------------------------------------------------+--------------------------------------------------+
   | Parameter       | Type                                            | Description                                      |
   +=================+=================================================+==================================================+
   | proxyConfig     | :ref:`Table 10 <asm_api_0104___d0e5946>` object | Data plane configuration of the service mesh.    |
   +-----------------+-------------------------------------------------+--------------------------------------------------+
   | telemetryConfig | :ref:`Table 11 <asm_api_0104___d0e6025>` object | Observability configuration of the service mesh. |
   +-----------------+-------------------------------------------------+--------------------------------------------------+

.. _asm_api_0104___d0e5946:

.. table:: **Table 10** ProxyConfig
...
.. _asm_api_0104___d0e6025:

.. table:: **Table 11** TelemetryConfig

   +-----------+-------------------------------------------------+----------------------------------------------------------------------------+
   | Parameter | Type                                            | Description                                                                |
   +===========+=================================================+============================================================================+
   | tracing   | :ref:`Table 12 <asm_api_0104___d0e6212>` object | Tracing configuration, which is used to report traces in the service mesh. |
   +-----------+-------------------------------------------------+----------------------------------------------------------------------------+

.. _asm_api_0104___d0e6212:

.. table:: **Table 12** Tracing
   ...
   +--------------------------+-----------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | extensionProviders       | Array of :ref:`Table 13 <asm_api_0104___d0e6268>` objects | User-defined provider. Currently, Zipkin is supported.                                                                                                                   |
   |                          |                                                           |                                                                                                                                                                          |
   |                          |                                                           | If you configure the Zipkin provider, ensure that the service mesh version is 1.15 or later.                                                                             |
   +--------------------------+-----------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _asm_api_0104___d0e6268:

.. table:: **Table 13** TracingExtensionProvider
   ...
   +-----------+-------------------------------------------------+---------------------------------------+
   | zipkin    | :ref:`Table 14 <asm_api_0104___d0e6309>` object | Self-defined configuration of Zipkin. |
   +-----------+-------------------------------------------------+---------------------------------------+

.. _asm_api_0104___d0e6309:

.. table:: **Table 14** ZipkinTracingProvider
