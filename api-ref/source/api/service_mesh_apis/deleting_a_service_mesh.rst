:original_name: asm_api_0102.html
...
.. table:: **Table 3** Parameters in the response body
   ...
   +-----------------------+-------------------------------------------------+------------------------------------------------------------------------------------------------+
   | metadata              | :ref:`Table 4 <asm_api_0102___d1e1754>` object  | Basic information about the service mesh. Metadata is a collection of attributes.              |
   +-----------------------+-------------------------------------------------+------------------------------------------------------------------------------------------------+
   | spec                  | :ref:`Table 5 <asm_api_0102___d1e1829>` object  | Detailed description of the service mesh. ASM creates or updates the service mesh by **spec**. |
   +-----------------------+-------------------------------------------------+------------------------------------------------------------------------------------------------+
   | status                | :ref:`Table 14 <asm_api_0102___d1e2130>` object | Service mesh status,                                                                           |
   |                       |                                                 |                                                                                                |
   |                       |                                                 | which is automatically generated by ASM.                                                       |
   +-----------------------+-------------------------------------------------+------------------------------------------------------------------------------------------------+

.. _asm_api_0102___d1e1754:
...
.. table:: **Table 5** MeshSpec
   ...
   +-----------------------+------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+
   | extendParams          | :ref:`Table 6 <asm_api_0102___d1e1892>` object | Extensions of the service mesh.                                                                                                     |
   +-----------------------+------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+
   | ipv6Enable            | Boolean                                        | Whether the service mesh supports IPv6.                                                                                             |
   +-----------------------+------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+
   | config                | :ref:`Table 8 <asm_api_0102___d0e3128>` object | Service mesh configuration.                                                                                                         |
   +-----------------------+------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+

.. _asm_api_0102___d1e1892:
...
.. table:: **Table 6** MeshExtendParams
   ...
   | Parameter | Type                                                     | Description                              |
   +===========+==========================================================+==========================================+
   | clusters  | Array of :ref:`Table 7 <asm_api_0102___d1e1924>` objects | Cluster information in the service mesh. |
   +-----------+----------------------------------------------------------+------------------------------------------+

.. _asm_api_0102___d1e1924:
...
.. table:: **Table 8** MeshConfig
   ...
   | Parameter       | Type                                            | Description                                      |
   +=================+=================================================+==================================================+
   | proxyConfig     | :ref:`Table 9 <asm_api_0102___d0e3227>` object  | Data plane configuration of the service mesh.    |
   +-----------------+-------------------------------------------------+--------------------------------------------------+
   | telemetryConfig | :ref:`Table 10 <asm_api_0102___d0e3306>` object | Observability configuration of the service mesh. |
   +-----------------+-------------------------------------------------+--------------------------------------------------+

.. _asm_api_0102___d0e3227:
...
.. table:: **Table 10** TelemetryConfig
   ...
   | Parameter | Type                                            | Description                                                                |
   +===========+=================================================+============================================================================+
   | tracing   | :ref:`Table 11 <asm_api_0102___d0e3493>` object | Tracing configuration, which is used to report traces in the service mesh. |
   +-----------+-------------------------------------------------+----------------------------------------------------------------------------+

.. _asm_api_0102___d0e3493:
...
.. table:: **Table 11** Tracing
   ...
   +--------------------------+-----------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | extensionProviders       | Array of :ref:`Table 12 <asm_api_0102___d0e3549>` objects | User-defined provider. Currently, Zipkin is supported.                                                                                                                   |
   |                          |                                                           |                                                                                                                                                                          |
   |                          |                                                           | If you configure the Zipkin provider, ensure that the service mesh version is 1.15 or later.                                                                             |
   +--------------------------+-----------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _asm_api_0102___d0e3549:
...
.. table:: **Table 12** TracingExtensionProvider
   ...
   +-----------+-------------------------------------------------+---------------------------------------+
   | zipkin    | :ref:`Table 13 <asm_api_0102___d0e3590>` object | Self-defined configuration of Zipkin. |
   +-----------+-------------------------------------------------+---------------------------------------+

.. _asm_api_0102___d0e3590:
